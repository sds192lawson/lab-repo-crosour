...
# a sequential pallett is created. it ranges from dark to light blue. 
# we gain information about traffic volumes. we see a lot of darker points for older bridges (but also more generally across all ages). we see lighter points aroung 1960 and in more recent years.
# i would interpret that newer highway bridges have mre traffic volume on their inventory routes than the older ones.
...
# the plot now has informatin about daily traffic volumes as well as material and design of the structures. where these points overlapp we can try to make inferences on how the variables relate.
```
