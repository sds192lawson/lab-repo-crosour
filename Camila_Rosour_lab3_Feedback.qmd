...
nbi_hampshire |>
  ...
  geom_point(size = 2, alpha = .5, position = "jitter") + #the changes in this line made the points larger, changed the opacity of the point, and jitter makes the points move randomly.
  labs(title = "Highway Bridge Conditions, Hampshire County, MA, 2024",
       x = "Year Built", 
       y = "Structural Evaluation") +
  theme_minimal()
##TA Feedback: This graph looks great, but remember jitter doesn't move points completley randomly, generally it just moves them a tiny bit laterally or horizontally so that they retain the same x and y. +3
##Total for Q1: 3 pts
...
nbi_hampshire |>
  ...
  labs(title = "Highway Bridge Conditions, Hampshire County, MA, 2024",
       ...
       col = "Route Prefix") +
  theme_minimal()
##TA Feedback: This graph looks awesome, good job! +3
...
Volume for Inventory Route") +
  theme_minimal()

# a sequential pallet is created. it ranges from dark to light blue. 
# we gain information about traffic volumes. we see a lot of darker points for older bridges (but also more generally across all ages). we see lighter points around 1960 and in more recent years.
# i would interpret that newer highway bridges have more traffic volume on their inventory routes than the older ones.
...
nbi_hampshire |>
  ...
  labs(title = "Highway Bridge Conditions, Hampshire County, MA, 2024",
       x = "Year Built", 
       y = "Structural Evaluation",
       shape = "Material And/Or Design of Structure") +
  theme_minimal()
...
# the plot now has information about daily traffic volumes as well as material and design of the structures. where these points overlap we can try to make inferences on how the variables relate.
...
##TA Feedback: Great job on this final graph! +3
